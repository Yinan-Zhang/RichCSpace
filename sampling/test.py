...
def main():
	...
	random_configs = sampler.random_configs(4, 15000, dimensions);
	ma_samples = sampler.sample_medial_axis(random_configs, dimensions, 'L2');
	sampler.save_data(ma_samples, 'BlockRobotMASamplesL2.txt');
	...
	pygame.image.save(DISPLAYSURF, 'BlockRobotL2.PNG');
